...
By default nginx-proxy generates location blocks to handle ACME HTTP Challenge. To disable this behavior set `ACME_HTTP_CHALLENGE=false` at the nginx-proxy container level or at the app container one.
